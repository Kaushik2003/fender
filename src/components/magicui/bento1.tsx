...
export function Bento1() {
  ...
  return (
    <div
      className="relative flex h-[200px] w-full items-center justify-center overflow-hidden p-6"
      ref={containerRef}
    >
      <div className="flex size-full max-h-[150px] max-w-lg flex-col items-stretch justify-between gap-6">
